...
void main()
{
  ...
  v_uv_anim_3.x = (a_vertPosition.x + (u_deltaTime * (u_noise2_move_speed + noise3_distance_from_noise2) * 0.125)) * 0.25 + 0.65;
  v_uv_anim_3.y = (a_vertPosition.y - (u_deltaTime * (u_noise2_move_speed + noise3_distance_from_noise2))) * 0.25 + 0.65;
